<template>
    <div class="terminal">
            ...
            <Table :datas="datas" stripe checkbox ref="tabler" align="center" @trclick="detaile()">
                <TableItem title="序号">
                        ...
                        <Modal v-model="opened">
                            ...
                            <div :style="{'height': height ? '800px' : 'auto'}">
                                ...
                                <div>
                                    <p>新计算终端：{{value}}</p>
                                    <div>
                                        <input type="text" v-model="value" placeholder="请输入新计算终端" />
                                    </div>
                                </div>
                            </div>
                            <div slot="footer">
            ...
            <Modal v-model="addStatus">
                ...
                <div :style="{'height': height ? '800px' : 'auto'}">
                    ...
                    <div>
                        <p>新计算终端：{{valueAdd}}</p>
                        <div>
                            <input type="text" v-model="valueAdd" placeholder="请输入新计算终端" />
                        </div>
                    </div>
                </div>
                <div slot="footer">
